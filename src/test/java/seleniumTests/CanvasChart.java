...
public class CanvasChart extends WebBase {
	...
	public void chartData1718IsCorrect() {
		...
		Assert.assertEquals("Chart data for 2017/2018 are incorrect", expectedChartData,actualChartData);
	}
	...
	public void chartData171819IsCorrect() {
		...
		Assert.assertEquals("Chart data for 2017/2018/2019 are incorrect", expectedChartData,actualChartData);
	}
